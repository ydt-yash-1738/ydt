...
//                 <div className="absolute inset-6 transform rotate-0">
...
//                 <div className="absolute inset-12 transform rotate-0">
...
//                 <div className="absolute top-6 right-8 w-4 h-4 bg-cyan-400 animate-float"
//                      style={{ clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' }}>
//                 </div>

//                 <div className="absolute bottom-8 left-6 w-3 h-3 bg-cyan-300 animate-float delay-700"
//                      style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }}>
//                 </div>

//                 <div className="absolute top-16 left-4 w-5 h-2 bg-cyan-500 animate-float delay-300"
//                      style={{ transform: 'rotate(45deg)' }}>
//                 </div>

//                 <div className="absolute bottom-16 right-6 w-3 h-3 bg-gradient-to-r from-cyan-400 to-cyan-300 rounded-full animate-float delay-1000">
//                 </div>

//                 {/* Center content */}
//                 <div className="absolute inset-0 flex items-center justify-center">
//                   <div className="text-center p-6 rounded-2xl bg-black/20 backdrop-blur-sm border border-cyan-400/20">
//                     <Code className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-cyan-400 mx-auto mb-3 sm:mb-4 animate-float" />
//                     <div className="text-xs sm:text-sm text-gray-400 font-medium">MERN Stack</div>
//                     <div className="text-base sm:text-lg text-cyan-400 font-bold">Developer</div>
//                   </div>
...
//                 {/* Corner accents */}
//                 <div className="absolute -top-2 -right-2 w-8 h-8 border-2 border-cyan-400 opacity-60"
//                      style={{ clipPath: 'polygon(0 0, 100% 0, 100% 100%)' }}>
//                 </div>

//                 <div className="absolute -bottom-2 -left-2 w-8 h-8 border-2 border-cyan-400 opacity-60"
//                      style={{ clipPath: 'polygon(0 0, 0 100%, 100% 100%)' }}>
//                 </div>

//                 {/* Glowing lines */}
//                 <div className="absolute top-1/4 left-0 w-16 h-0.5 bg-gradient-to-r from-transparent to-cyan-400 animate-pulse"></div>
//                 <div className="absolute bottom-1/4 right-0 w-16 h-0.5 bg-gradient-to-l from-transparent to-cyan-400 animate-pulse delay-500"></div>
//               </div>
//             </div>
//           </div>
//         </div>
...
//                 {/* Inner hexagonal layers */}
//                 <div className="absolute inset-4 sm:inset-6 transform rotate-0">
//                   <div className="w-full h-full border border-cyan-400/20"
//                        style={{
//                          clipPath: 'polygon(50% 0%, 93% 25%, 93% 75%, 50% 100%, 7% 75%, 7% 25%)',
//                          background: 'rgba(34, 211, 238, 0.03)'
...
//                 <div className="absolute inset-8 sm:inset-10 transform rotate-0">
//                   <div className="w-full h-full border border-cyan-400/10"
//                        style={{
//                          clipPath: 'polygon(50% 0%, 93% 25%, 93% 75%, 50% 100%, 7% 75%, 7% 25%)',
//                          background: 'rgba(34, 211, 238, 0.02)'
...
//                 {/* Center content */}
//                 <div className="absolute inset-0 flex items-center justify-center">
//                   <div className="text-center p-2 sm:p-3 md:p-4 rounded-2xl bg-black/20 backdrop-blur-sm border border-cyan-400/20">
//                     <Code className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 text-cyan-400 mx-auto mb-1 sm:mb-2 animate-float" />
//                     <div className="text-xs text-gray-400 font-medium">Full Stack</div>
//                     <div className="text-xs sm:text-sm md:text-base text-cyan-400 font-bold">Developer</div>
//                   </div>
//                 </div>
...
//             <div className={`relative ${isVisible ? 'animate-slide-left delay-500' : 'opacity-0 translate-x-12'}`}>
//               {/* Main hexagonal container */}
//               <div className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-64 md:w-64 lg:w-64 lg:h-64 xl:w-72 xl:h-72">
//                 {/* Hexagonal background */}
//                 <div className="absolute inset-0 transform rotate-0">
//                   <div className="w-full h-full border-2 border-cyan-400/30 relative"
//                        style={{
...
//                 {/* Center content */}
//                 <div className="absolute inset-0 flex items-center justify-center">
//                   <div className="text-center p-2 sm:p-3 md:p-4 lg:p-3 rounded-2xl bg-black/20 backdrop-blur-sm border border-cyan-400/20">
